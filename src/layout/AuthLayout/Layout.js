...
import { ReactComponent as BestWishesLogo } from "../../assets/images/bestwishes-logo.svg";
...
export default function AuthLayout() {
  ...
  return (
    <div
      className={`w-full min-h-screen font-lexend h-full flex  justify-between ${flexDirection} `}
    >
      <img
        src={backgroundImage}
