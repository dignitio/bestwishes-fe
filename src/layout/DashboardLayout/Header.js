...
function Header() {
    ...
    return ( 
        <div className="bg-white flex justify-between items-center max-sm:pl-2.5 py-6 px-2 max-lg:pl-6 max-lg:py-8">
            ...
            <div className="flex items-center text-base">
                <Button onClick={() => setOpen(!open)} type={Button} className="bg-primary max-md:h-12 text-white max-md:ml-16 mx-10 max-md:mx-4  max-sm:ml-6 hover:bg-red-500 max-sm:px-2.5 max-sm:w-44 h-12 rounded-lg">
                    Create Tribute +
                </Button>
