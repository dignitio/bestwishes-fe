...
const SuccessPage: React.FC<SuccessPageProps> = ({ onClose, transactionRowData }) => {
  console.log(Transactions);
  const mapDataToDetails = (data: any) => {
    return [
  ...
  const getCurrentStatus = (transactionStatus: string) => {
  ...
  const getTransactionTitle = (transactionStatus: string) => {
    switch (transactionStatus) {
      case "Successful":
        return "Successful";
      case "Pending":
