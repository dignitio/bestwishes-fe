...
const EditWishlist: React.FC = () => {
  ...
  const foundWishlist = wishListData.find((wishlist) => wishlist.id === parseInt(id || "0", 10));
            ...
            <div className=" w-full">
              ...
              <div className="bg-white h-full w-auto mx-10 p-10 overflow-hidden flex flex-col items-start border rounded-lg">
                ...
                <div className=" w-full grid grid-cols-1 md:grid-cols-2  xl:grid-cols-3 gap-6 my-5 ">
                  ...
                  {editWishlistdata.map((editWishlist: any, index: number) => (
                    <div key={index} className="h-[317px] w-full rounded-md">
                      <div
