...
const ImageModal: React.FC<ImageModalProps> = ({ uploadedPictures }) => {
  return (
    <div className="flex flex-col gap-[20px]">
      ...
      <div className="flex flex-wrap h-[561px] gap-[30px] justify-center relative overflow-y-scroll mb-[50px]">
        {uploadedPictures.map((items: any, index: number) => (
          <div key={index} className="w-[180px] h-[150px] object-cover">
