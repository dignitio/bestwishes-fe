          ...
          <div className="mt-9 mr-16 w-9/12 max-lg:w-full">
            ...
            <div className="bg-white rounded-xl px-4 max-sm:px-1 max-md:px-2.5 pt-1 pb-6 max-sm:pb-2">
              {userDetails.map((user: any, index: number) => (
                <div
                  key={`${user.photoSRC}-${user.fullName}`}
                  className="bg-gray-50 my-5 max-lg:my-3 max-lg:mb-4 flex max-sm:block items-center py-5 px-3.5 max-sm:px-2 rounded-lg">
            ...
            <div className="bg-white pt-1 pb-1 px-4 max-sm:px-5 rounded-xl w-96 max-lg:w-full">
              {activities.map((activity: any, index: number) => (
                <div
                  ...
                  className="flex max-lg:items-center my-6 max-md:mb-8 max-lg:mb-10">
                  <div>
