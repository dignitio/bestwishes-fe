...
const CreateTribute: React.FC = () => {
  const [activeStep, setActiveStep] = useState(0);
  const [open, setOpen] = useState(false);
  const [birthCalendarId, setBirthCalenderId] = useState<string | null>(null);
  const [deathCalendarId, setDeathCalenderId] = useState<string | null>(null);
    ...
    <div>
      <Formik
        initialValues={{
          ...
          tributeKey: "BWT-",
          otherImages: [
            { firstOtherImg: "", secondOtherImg: "", thirdOtherImg: "", fourthOtherImg: "" }
          ],
        }}
            ...
            {activeStep === 0 && (
              <div className="text-lg step-1 max-sm:w-80 max-sm:mx-auto max-sm:h-[480px]">
                <div className="max-md:pb-6">
                  <fieldset className="relative h-[150px] w-[150px] flex justify-center mt-0  mx-auto cursor-pointer bg-white">
                    {values.headerImage ? (
                  ...
                  <div className="block md:grid md:grid-cols-2 md:justify-between my-6 max-sm:my-4 placeholder:italic gap-10">
                    <CustomSelect name="tributeType" label="Type of Tribute">
                ...
                <div className="max-md:pb-6 max-md:-mt-8">
                  ...
                  <div className="my-8 max-md:mt-0">
                    ...
                    <div>
                            ...
                            >
                              {item.firstOtherImg ? (
                                <div className="w-full rounded-lg h-full relative pt-3">
                                  ...
                                  <img
                                    src={URL.createObjectURL(item.firstOtherImg as unknown as Blob)}
                              ...
                              {item.secondOtherImg ? (
                                <div className="w-full rounded-lg h-full relative pt-3">
                                  <button
                                    ...
                                    className=" font-bold text-lg text-red-500 z-30 absolute top-4 left-20 "
                                    onClick={() =>
                                      setFieldValue(`otherImages.${index}.secondOtherImg`, null)
                                    }
                                  >
                                    X
                                  </button>
                                  ...
                                  <img
                                    src={URL.createObjectURL(item.secondOtherImg as unknown as Blob)}
                                    className="w-24 h-24 object-cover"
                              ...
                              {item.thirdOtherImg ? (
                                <div className="w-full rounded-lg h-full relative pt-3">
                                  <button
                                    ...
                                    className=" font-bold text-lg text-red-500 z-30 absolute top-4 left-20 "
                                    onClick={() =>
                                      setFieldValue(`otherImages.${index}.thirdOtherImg`, null)
                                    }
                                  >
                                    X
                                  </button>
                                  ...
                                  <img
                                    src={URL.createObjectURL(item.thirdOtherImg as unknown as Blob)}
                                    className="w-24 h-24 object-cover"
                                    alt="second Cover pic"
                                  />
                                </div>
                              ...
                              {item.fourthOtherImg ? (
                                <div className="w-full rounded-lg h-full relative pt-3">
                                  <button
                                    ...
                                    className=" font-bold text-lg text-red-500 z-30 absolute top-4 left-20 "
                                    onClick={() =>
                                      setFieldValue(`otherImages.${index}.fourthOtherImg`, null)
                                    }
                                  >
                                    X
                                  </button>
                                  ...
                                  <img
                                    src={URL.createObjectURL(item.fourthOtherImg as unknown as Blob)}
                                    className="w-24 h-24 object-cover"
                                    alt="second Cover pic"
                                  />
                                </div>
                      ...
                      <p className="mr-3 text-sm text-sky-500 max-md:mt-8">
