...
const EditWishcardLibrary: React.FC = () => {
    ...
    const handleBackBgColorChange = (color: any) => {
        setBackChosedBgColor(color);
    };

    const handleCaseChange = (caseName: any) => {
        setWords((prev: any) => ({
            ...prev,
            [selectedValue]: {
                ...prev[selectedValue],
    ...
    const handleAlignChange = (alignName: any) => {
        setWords((prev: any) => ({
            ...prev,
            [selectedValue]: {
                ...prev[selectedValue],
    ...
    const handleBackImageUpload = (event: any) => {
        const file = event.target.files?.[0];
        if (file) {
            const reader = new FileReader();
            reader.onload = (uploadEvent: any) => {
    ...
    const handleBgColorChange = (color: any) => setChosedBgColor(color);


    const handleImageSize = (event: any) => {
        const { name, value } = event.target
        setImageProperty((prevProperty: any) => ({
            ...prevProperty,
            [name]: value
        }));
    };
                                            ...
                                            <div>
                                                <div>
                                                    ...
                                                    <h2 onClick={() => setSelectedValue("headTextWording")}
                                                        style={{
                                                            color: words.headTextWording.textColor, fontSize: `${words.headTextWording.textSize}px`, letterSpacing: `${words.headTextWording.letterSpacing}px`,
                                                            fontFamily: `${words.headTextWording.fontFamily}`, fontWeight: `${words.headTextWording.fontWeight}`, textTransform: words.headTextWording.textTransform as any, textAlign: words.headTextWording.textAlign as any
                                                        }
                                                        }
                                                    ...
                                                    <p onClick={() => setSelectedValue("titleTextWording")}
                                                        style={{
                                                            color: words.titleTextWording.textColor, fontSize: `${words.titleTextWording.textSize}px`, letterSpacing: `${words.titleTextWording.letterSpacing}px`,
                                                            fontFamily: `${words.titleTextWording.fontFamily}`, fontWeight: `${words.titleTextWording.fontWeight}`, textTransform: words.titleTextWording.textTransform as any, textAlign: words.titleTextWording.textAlign as any
                                                        }
                                                        }
                                                    ...
                                                    <p onClick={() => setSelectedValue("footerTextWording")}
                                                        style={{
                                                            color: words.footerTextWording.textColor, fontSize: `${words.footerTextWording.textSize}px`, letterSpacing: `${words.footerTextWording.letterSpacing}px`,
                                                            fontFamily: `${words.footerTextWording.fontFamily}`, fontWeight: `${words.footerTextWording.fontWeight}`, textTransform: words.footerTextWording.textTransform as any, textAlign: words.footerTextWording.textAlign as any
                                                        }
                                                        }
                                                                    ...
                                                                    <div className="relative">
                                                                        ...
                                                                        <input
                                                                            ...
                                                                            onChange={(e: any) => {
                                                                                ...
                                                                                if (file) {
                                                                                    setFieldValue("centerImage", file);
                                                                                }
                                                                            }}
                                                                        />
                                                                    </div>
                                            ...
                                            <div>
                                                <div>
                                                    ...
                                                    <h2 onClick={() => setSelectedValue("backHeadTextWording")}
                                                        style={{
                                                            color: words.backHeadTextWording.textColor, fontSize: `${words.backHeadTextWording.textSize}px`, letterSpacing: `${words.backHeadTextWording.letterSpacing}px`,
                                                            fontFamily: `${words.backHeadTextWording.fontFamily}`, fontWeight: `${words.backHeadTextWording.fontWeight}`, textTransform: words.backHeadTextWording.textTransform as any, textAlign: words.backHeadTextWording.textAlign as any
                                                        }
                                                        }
                                                    ...
                                                    <p onClick={() => setSelectedValue("backFooterTextWording")}
                                                        style={{
                                                            color: words.backFooterTextWording.textColor, fontSize: `${words.backFooterTextWording.textSize}px`, letterSpacing: `${words.backFooterTextWording.letterSpacing}px`,
                                                            fontFamily: `${words.backFooterTextWording.fontFamily}`, fontWeight: `${words.backFooterTextWording.fontWeight}`, textTransform: words.backFooterTextWording.textTransform as any, textAlign: words.backFooterTextWording.textAlign as any
                                                        }
                                                        }
