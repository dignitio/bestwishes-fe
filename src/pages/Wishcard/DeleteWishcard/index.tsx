...
const DeleteTribute: React.FC = () => {
    const [open , setOpen] = useState(false)
    return ( 
        <div className="max-w-lg max-sm:max-w-[23em] mx-auto">
            <TrashIcon className="w-32 max-sm:w-28 h-32 mx-auto mb-5 max-sm:mb-3"/>
            <h3 className="font-semibold text-center mx-auto max-md:text-xl text-2xl max-sm:max-w-full pt-3 max-md:pt-0">Are you sure you want to delete this wishcard?</h3>
            ...
            <div className="flex justify-between text-white text-lg max-md:text-base mb-5 max-sm:mx-0 max-lg:mx-8 mx-3">
                <DeleteDropdown heading={<Button type="button" className="bg-red-400 h-12 max-lg:h-11 px-10 max-md:ml-6 rounded-lg">
                    yes Delete!
                </Button>}>
