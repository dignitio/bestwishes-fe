...
const Dragdrop: React.FC<DragdropProps> = ({ images, setImages }) => {
  ...
  const handleFileInputChange = ({ target: { files } }: React.ChangeEvent<HTMLInputElement>) => {
  ...
  return (
    <div
      className={`flex justify-center items-center border-dashed border cursor-pointer  ${isDragOver ? "border-[#4CAF50]" : "border-[#E5E7EB]"
